...
angular.module('evtviewer.term')
   ...
   .provider('evtTermRef', function () {
      ...
      this.$get = function ($timeout, $http, parsedData, evtNamedEntitiesParser, baseData, Utils) {
        ...
        //           if (namedEntityRef.getCurrentHighlighted() !== vm.entityId) {
        //              namedEntityRef.highlightByEntityId(undefined);
        //              var url = "http://ditmao-dev.ilc.cnr.it:8082/RESTfulExample/rest/json/saussure/get";
        ...
        //              _$http.success = (function (data, status, headers, config) {
        ...
        //        goToEntityInListHTTP: goToEntityInListHTTP
        //     };
